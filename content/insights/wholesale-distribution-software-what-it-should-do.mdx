...
metaTitle: "What Distribution Software Should Do"
description: "What decides whether a distribution system holds up: credit control at order entry, one stock pool across every channel, accounting that posts itself."
date: "2026-08-04"
keywords:
...
We have published a demonstration of a multi-branch distribution system — trade desk, [point-of-sale](/industries/retail) till, and a consumer storefront over a single catalogue, one stock pool and one ledger — including the credit holds, backorder queue and drawer variance described above.

It is our own product, Corewell Trade, and the public instance runs on sample data, so every screen is open without a signup. It is also the fastest way to see whether this shape of system matches how you actually work.

It is called [Corewell Trade](/trade). That page takes the six questions above in order, screen by screen.
