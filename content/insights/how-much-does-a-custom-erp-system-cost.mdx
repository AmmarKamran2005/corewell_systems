...
description: "What drives the price of an ERP or POS build up and down, how it compares against a subscription over three years, and how to scope one so you pay for workflow."
date: "2026-08-04"
keywords:
  - "custom erp cost"
...
We have published a working demonstration of a multi-branch distribution system — trade desk, [point-of-sale](/industries/retail) till and consumer storefront over a single catalogue, one stock pool and one ledger. It is our own product, Corewell Trade, and the public instance runs on sample data so you can open every screen without a signup.

Judging scope from a system you can click through is considerably more reliable than judging it from a proposal.

It is called [Corewell Trade](/trade), and that page lists every module in it — which is the closest thing to a scope document you will get before a conversation.
